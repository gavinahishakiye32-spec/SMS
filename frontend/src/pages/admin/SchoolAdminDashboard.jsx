    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-900 rounded-xl shadow p-5">
        ...
        <div className="flex justify-between items-center mb-4">
          <span className="text-gray-600">Pass Rate: <strong className="text-green-600">{analytics?.passRate || 0}%</strong></span>
          <span className="text-gray-600">Fail Rate: <strong className="text-red-600">{analytics?.failRate || 0}%</strong></span>
        </div>
