    ...
    <div className="space-y-4">
      ...
      {subjectList.length === 0 ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {subjectList.map((s) => (
            <div key={s.subjectId?._id || s._id} className="bg-white dark:bg-gray-900 rounded-xl shadow p-5">
              <h3 className="text-lg font-bold text-gray-900 dark:text-white">{s.subjectId?.name || s.name}</h3>
